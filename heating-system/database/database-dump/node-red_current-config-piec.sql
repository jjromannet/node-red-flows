...
--
-- Table structure for table `current-config-piec`
--

DROP TABLE IF EXISTS `current-config-piec`;
...
--
-- Dumping data for table `current-config-piec`
--

LOCK TABLES `current-config-piec` WRITE;
/*!40000 ALTER TABLE `current-config-piec` DISABLE KEYS */;
INSERT INTO `current-config-piec` VALUES (1,65.00,7,2,9,1,34);
/*!40000 ALTER TABLE `current-config-piec` ENABLE KEYS */;
UNLOCK TABLES;
